...
const styles=(C:ThemePalette)=>StyleSheet.create({shade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(7,12,20,.8)'},root:{padding:spacing.lg,gap:spacing.md},kicker:{...typography.caption,color:C.accent,fontWeight:'900',letterSpacing:1.2},h:{...typography.hero,color:C.text},region:{overflow:'hidden',minHeight:112,flexDirection:'row',alignItems:'center',gap:spacing.md,padding:spacing.md,backgroundColor:C.panel,borderWidth:1,borderRadius:radii.lg},flex:{flex:1,minWidth:0},regionLabel:{...typography.caption,color:C.muted,fontWeight:'900',letterSpacing:.8},regionName:{...typography.title,color:C.accentSoft},sub:{...typography.body,color:C.muted},change:{width:92},section:{...typography.caption,color:C.accentSoft,fontWeight:'900',letterSpacing:1},tactics:{gap:8,padding:spacing.sm,borderWidth:1,borderColor:C.line,borderRadius:radii.md,backgroundColor:C.panel},tacticCopy:{gap:2},tacticRow:{flexDirection:'row',gap:6},goalRow:{gap:6},goalButton:{minHeight:34,paddingHorizontal:10,alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:C.line,borderRadius:99,backgroundColor:C.bg},tacticButton:{flex:1,minHeight:36,alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:C.line,borderRadius:99,backgroundColor:C.bg},tacticSelected:{borderColor:C.action,backgroundColor:C.actionSurface},tacticText:{fontSize:11,color:C.muted,fontWeight:'900'},tacticTextSelected:{color:C.text},activeTactic:{...typography.caption,color:C.info,fontWeight:'900',letterSpacing:.6},momentumHint:{...typography.caption,color:C.good,fontWeight:'800',lineHeight:16}});
