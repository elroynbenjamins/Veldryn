-- Enchanting refinement follow-up: regional gem rewards now land as unrefined family gems.
-- Pity/source isolation remains unchanged; only the granted item identity changes.
...
begin
  ...
  if v_hit then
    ...
    v_item_id:='raw_gem:'||v_family||':g'||v_grade::text;
