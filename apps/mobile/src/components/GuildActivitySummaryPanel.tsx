...
export function GuildActivitySummaryPanel({compact=false}:{compact?:boolean}){
 ...
 const next=guildActivityNextMilestone(state.activityPercent);
 ...
 return <Panel>
  ...
  <View accessibilityRole="progressbar" accessibilityValue={{min:0,max:100,now:state.activityPercent}} style={s.track}><View style={[s.fill,{width:(state.activityPercent+'%') as any}]}/></View>
...
function makeStyles(C:ThemeColors){return StyleSheet.create({
 ...
 track:{height:9,borderRadius:5,overflow:'hidden',backgroundColor:C.panel2,marginVertical:8},fill:{height:'100%',backgroundColor:C.accent},
