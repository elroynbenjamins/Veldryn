...
const v161Contract = { id: 'c161', name: 'Mixed weekly', focus: 'mixed', description: '', targetPoints: 4000, totalPoints: 2100, combatPoints: 1200, skillingPoints: 900, personalPoints: 400, eligible: true, complete: false, expiresAt: '2026-09-14T00:00:00Z' };
assert((0, party_social_1.contractProgressPercent)(v161Contract) === 53, 'v16.1 presentation progress');
assert((0, party_social_1.contractEligibilityLabel)(v161Contract) === 'Reward eligible', 'v16.1 eligibility label');
