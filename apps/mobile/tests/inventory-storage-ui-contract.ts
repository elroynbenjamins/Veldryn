...
ok(normalization.includes('uiTheme:'),'Theme selection must survive save normalization alongside inventory preferences');
...
console.log('PASS: compact inventory/bank controls, favorites, capacity feedback and rarity frame contract');
