...
export const COMPANION_WEEKLY_CHALLENGES:CompanionWeeklyChallengeDefinition[]=[
 ...
 {id:'AFFINITY_TRIAD',name:'Threefold Nature',description:'Clear Floor 10+ with three different Companion Affinities.',minimumFloor:10,restrictions:[{type:'affinity_unique'}],rewards:{companionEssence:145,bondstones:0,gold:3000,materials:{TRIAL_SANCTUARY_MATERIAL:1}}},
 {id:'RADIANT_UMBRAL',name:'Light and Shadow',description:'Clear Floor 15+ with at least one Radiant and one Umbral companion.',minimumFloor:15,restrictions:[{type:'require_affinity',affinity:'radiant',count:1},{type:'require_affinity',affinity:'umbral',count:1}],rewards:{companionEssence:150,bondstones:0,gold:3150}},
...
export const COMPANION_MISSIONS:CompanionMissionDefinition[]=[
 ...
 {id:'MISSION_ASTERFALL_SHRINE_8H',name:'Forgotten Asterfall Shrine',originId:'REG_001',durationMs:8*3600_000,missionVersion:1,minCompanions:3,maxCompanions:3,minimumPenLevel:2,minimumBondLevel:4,recommendedPower:3000,requirements:[{type:'min_bond',value:4},{type:'min_rarity',rarity:'rare',count:1}],bonusRequirements:[{type:'origin_count',originId:'REG_001',count:3},{type:'affinity_unique'}],costs:{gold:1050,materials:{SUPPLIES:3}},baseRewards:{companionEssence:14,gold:900,companionXp:250,bondXp:30,materials:{IRONWOOD_FANG:3}},bonusRewards:{companionEssence:7,materials:{TRIAL_SANCTUARY_MATERIAL:1}},bonusRewardChanceByGrade:{A:.06,S:.14}},
 {id:'MISSION_SUNSCAR_RUINS_8H',name:'Sunscar Ruin Survey',originId:'REG_SUNSCAR',durationMs:8*3600_000,missionVersion:1,minCompanions:3,maxCompanions:3,minimumPenLevel:2,minimumLevel:18,recommendedPower:3300,requirements:[{type:'role_count',role:'damage',count:1},{type:'role_count',role:'support',count:1},{type:'origin_count',originId:'REG_SUNSCAR',count:2},{type:'min_level',value:18},{type:'affinity_diversity',count:2}],bonusRequirements:[{type:'min_bond',value:5,count:2}],costs:{gold:1200,materials:{SUPPLIES:3}},baseRewards:{companionEssence:15,gold:1025,companionXp:285,bondXp:34,materials:{ASTRAL_SCRIPT:1}},bonusRewards:{companionEssence:7,materials:{SUNSTONE_ORE:1}},bonusRewardChanceByGrade:{A:.05,S:.12}},
 ...
 {id:'MISSION_IRONWOOD_TRACK_4H',name:'Ironwood Tracking Detail',originId:'REG_001',durationMs:4*3600_000,missionVersion:1,minCompanions:2,maxCompanions:2,minimumPenLevel:1,minimumLevel:10,recommendedPower:2200,requirements:[{type:'role_count',role:'damage',count:1},{type:'min_level',value:10},{type:'origin_count',originId:'REG_001',count:1}],bonusRequirements:[{type:'origin_count',originId:'REG_001',count:2},{type:'affinity_count',affinity:'wild',count:1}],costs:{gold:520,materials:{SUPPLIES:1}},baseRewards:{companionEssence:5,gold:470,companionXp:150,bondXp:18,materials:{THORN_SAP:2}},bonusRewards:{companionEssence:3,materials:{IRONWOOD_FANG:2}},bonusRewardChanceByGrade:{B:.05,A:.10,S:.16}},
 {id:'MISSION_SUNSCAR_RELIC_6H',name:'Sunscar Relic Survey',originId:'REG_SUNSCAR',durationMs:6*3600_000,missionVersion:1,minCompanions:2,maxCompanions:3,minimumPenLevel:2,minimumLevel:18,recommendedPower:3150,requirements:[{type:'role_count',role:'support',count:1},{type:'min_bond',value:4,count:2},{type:'origin_count',originId:'REG_SUNSCAR',count:1}],bonusRequirements:[{type:'origin_count',originId:'REG_SUNSCAR',count:2},{type:'affinity_count',affinity:'primal',count:1}],specialtyBonus:{label:'Relic recovery: +25% base material yield with the regional bonus team.',materialMultiplier:1.25},costs:{gold:900,materials:{SUPPLIES:2}},baseRewards:{companionEssence:7,gold:760,companionXp:215,bondXp:26,materials:{ASTRAL_SCRIPT:1}},bonusRewards:{companionEssence:5,materials:{SUNSTONE_ORE:2}},bonusRewardChanceByGrade:{A:.08,S:.15}},
 {id:'MISSION_FROST_RESONANCE_6H',name:'Frostmarch Resonance Survey',originId:'REG_FROSTMARCH',durationMs:6*3600_000,missionVersion:1,minCompanions:2,maxCompanions:3,minimumPenLevel:2,minimumLevel:18,recommendedPower:3250,requirements:[{type:'role_count',role:'tank',count:1},{type:'min_bond',value:5,count:2},{type:'origin_count',originId:'REG_FROSTMARCH',count:1}],bonusRequirements:[{type:'origin_count',originId:'REG_FROSTMARCH',count:2},{type:'affinity_count',affinity:'arcane',count:1}],specialtyBonus:{label:'Resonant bonding: +30% Bond XP with the regional bonus team.',bondXpMultiplier:1.30},costs:{gold:940,materials:{SUPPLIES:2}},baseRewards:{companionEssence:8,gold:800,companionXp:225,bondXp:28,materials:{CHOIR_BLOOM:1}},bonusRewards:{companionEssence:5,materials:{FROSTIRON:2}},bonusRewardChanceByGrade:{A:.07,S:.14}},
 {id:'MISSION_ASHLANDS_SALVAGE_8H',name:'Blackglass Salvage Run',originId:'REG_ASHLANDS',durationMs:8*3600_000,missionVersion:1,minCompanions:2,maxCompanions:3,minimumPenLevel:2,minimumLevel:20,recommendedPower:3600,requirements:[{type:'role_count',role:'damage',count:1},{type:'min_ascension',tier:1,count:2},{type:'origin_count',originId:'REG_ASHLANDS',count:1}],bonusRequirements:[{type:'origin_count',originId:'REG_ASHLANDS',count:2},{type:'affinity_count',affinity:'construct',count:1}],specialtyBonus:{label:'Salvage expertise: +30% base material yield with the regional bonus team.',materialMultiplier:1.30},costs:{gold:1250,materials:{SUPPLIES:3}},baseRewards:{companionEssence:12,gold:1050,companionXp:310,bondXp:36,materials:{BLACKGLASS_CORE:1}},bonusRewards:{companionEssence:7,materials:{BANNER_ASH:2}},bonusRewardChanceByGrade:{A:.06,S:.13}},
