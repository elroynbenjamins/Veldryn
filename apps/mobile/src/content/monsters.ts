...
{id:'IRONBACK_MOLE',name:'Ironback Mole',level:17,hp:280,attack:27,defense:18,xp:158,gold:9,secondsPerKill:21,unlockLevel:17,zone:'Old Mines',drops:[{itemId:'ASTER_IRON_ORE',chance:.40,min:1,max:2},{itemId:'COPPER_ORE',chance:.30,min:1,max:2},{itemId:'BP_ASTER_IRON_PICKAXE',chance:.05,min:1,max:1}]},
