...
export const COMPANION_MISSIONS:CompanionMissionDefinition[]=[
 ...
 {id:'MISSION_FROST_RESONANCE_6H',name:'Frostmarch Resonance Survey',originId:'REG_FROSTMARCH',durationMs:6*3600_000,missionVersion:1,minCompanions:2,maxCompanions:3,minimumPenLevel:2,minimumLevel:18,recommendedPower:3250,requirements:[{type:'role_count',role:'tank',count:1},{type:'min_bond',value:5,count:2},{type:'origin_count',originId:'REG_FROSTMARCH',count:1}],bonusRequirements:[{type:'origin_count',originId:'REG_FROSTMARCH',count:2}],specialtyBonus:{label:'Resonant bonding: +30% Bond XP with the regional bonus team.',bondXpMultiplier:1.30},costs:{gold:940,materials:{SUPPLIES:2}},baseRewards:{companionEssence:8,gold:800,companionXp:225,bondXp:28,materials:{CHOIR_BLOOM:1}},bonusRewards:{companionEssence:5,materials:{FROSTIRON:2}},bonusRewardChanceByGrade:{A:.07,S:.14}},
