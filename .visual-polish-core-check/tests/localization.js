...
for (const language of i18n_1.SUPPORTED_LANGUAGES) {
    ...
    const saved = { ...(0, game_1.newGame)(1000), settings: { ...(0, game_1.newGame)(1000).settings, language } };
...
ok((0, save_normalization_1.normalizeSave)({ ...(0, game_1.newGame)(1000), settings: { ...(0, game_1.newGame)(1000).settings, language: 'unknown' } }).settings.language === 'en', 'Unknown languages must fall back to English');
