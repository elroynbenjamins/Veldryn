...
export const GameTextInput=forwardRef<TextInput,TextInputProps>(function GameTextInput({style,multiline=false,editable=true,onFocus,onBlur,placeholderTextColor,...props},ref){
  ...
  return <TextInput {...props} ref={ref} multiline={multiline} editable={editable} accessibilityState={{...props.accessibilityState,disabled:!editable}} placeholderTextColor={placeholderTextColor??C.muted} selectionColor={props.selectionColor??C.selectionLine} underlineColorAndroid="transparent"
