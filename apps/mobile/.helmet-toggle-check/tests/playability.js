...
const switched = (0, playability_1.transitionActivity)(combat, 61000, { kind: 'gathering', id: 'COPPER_VEIN' });
...
const gathered = (0, playability_1.transitionActivity)((0, game_1.startGathering)(initial, 'COPPER_VEIN', 1000), 61000, { kind: 'combat', id: 'MOSS_RAT' });
