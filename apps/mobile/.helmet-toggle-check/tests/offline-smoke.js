...
let p = (0, game_1.previewActivityReward)(s, t0 + 60000);
ok(p.kills >= 5, 'Should kill several Moss Rats in 60 sec');
let c = (0, game_1.claimActivity)(s, t0 + 60000);
s = c.state;
ok(s.character.xp > 0 && s.character.gold > 100, 'Claim should award XP and gold');
const capped = (0, game_1.previewActivityReward)(s, t0 + 60000 + (game_1.OFFLINE_CAP_SECONDS + 3600) * 1000);
ok(capped.elapsedSeconds === game_1.OFFLINE_CAP_SECONDS, 'Offline progress must cap at 8 hours');
let level25Xp = (0, progression_1.totalXpAtLevel)(25);
ok(level25Xp > 0, 'Level curve should support level 25');
const a = (0, game_1.previewActivityReward)(s, t0 + 120000);
const b = (0, game_1.previewActivityReward)(s, t0 + 120000);
