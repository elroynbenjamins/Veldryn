...
function makeStyles(C:ThemeColors){return StyleSheet.create({
 root:{minHeight:48,flexDirection:'row',alignItems:'center',gap:spacing.sm,paddingHorizontal:12,paddingVertical:10,borderWidth:1,borderLeftWidth:3,borderRadius:radii.md},rootStack:{alignItems:'stretch',flexDirection:'column'},
 compact:{minHeight:40,paddingHorizontal:9,paddingVertical:7},copyRow:{flex:1,minWidth:0,flexDirection:'row',alignItems:'center',gap:spacing.sm},
 ...
 action:{minHeight:44,minWidth:72,alignItems:'center',justifyContent:'center',paddingHorizontal:10,borderWidth:1,borderRadius:99},actionStack:{width:'100%'},
