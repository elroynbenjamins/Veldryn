...
exports.LIVE_EVENT_CATALOG = void 0;
exports.liveEventDef = liveEventDef;
const harvestSkins = {
...
function liveEventDef(id) { return exports.LIVE_EVENT_CATALOG.find(event => event.id === id); }
