...
export function ProgressionPlannerScreen({state,onChange,onCommand}:{state:GameState;onChange:(next:GameState)=>void|Promise<void>;onCommand?:(command:GameCommand)=>Promise<void>}){
 ...
 return <><ScrollView contentContainerStyle={s.root}>
   ...
   <Panel><Text style={s.title}>Advanced Idle Rules</Text><Text style={s.copy}>Idle Rules are stop-only. Exact duration stops are active now; they cannot auto-travel, chain activities, or extend Offline Reserve.</Text>
