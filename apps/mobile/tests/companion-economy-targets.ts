...
ok(byRarity.prestige.ascension.companionEssence<=monthly.companionEssence,'One full monthly Trial should cover Prestige Ascension/Mastery Essence, leaving Bondstones/materials as the long-term gate');
...
ok(COMPANION_TECHNIQUE_SWITCH_COST.gold===0,'Technique switching should not add a second Gold tax');
