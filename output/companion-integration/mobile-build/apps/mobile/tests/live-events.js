...
ok(((0, game_1.previewActivityReward)(state, t0 + 3_600_000).eventDrops?.length ?? 0) === 0, 'Inactive events cannot add drops');
...
ok((0, live_events_1.eventDailyGift)(state, t0 + 86400_000)?.claimed === false, 'The next UTC day should offer a fresh festival gift');
...
const preview = (0, game_1.previewActivityReward)(state, t0 + 3_600_000);
...
ok((0, live_events_1.eventContractBoard)(state, t0 + 86400_000 + 2).every(contract => !contract.accepted), 'A new UTC day should provide fresh contract acceptance slots');
...
ok((0, live_events_1.eventLifecycle)(state, eventEnd + 8 * 86400_000) === null, 'Event should archive after the seven-day claim period');
