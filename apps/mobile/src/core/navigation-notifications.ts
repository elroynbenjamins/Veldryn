...
export type NotificationKind='friend_request'|'party_invite'|'guild_invite'|'guild_application'|'unread_dm'|'weekly_order_complete'|'reward_ready'|'collection_unlock'|'event_reward_ready'|'account_action';
