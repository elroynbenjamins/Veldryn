...
const makeStyles=(T:ThemePalette)=>StyleSheet.create({field:{minHeight:48,minWidth:0,flexDirection:'row',alignItems:'center',paddingLeft:12,borderWidth:1,borderColor:T.line,borderRadius:radii.md,backgroundColor:'#101B27'},focused:{borderColor:'#8BAFC2'},disabled:{opacity:.5},input:{flex:1,minWidth:0,borderWidth:0,backgroundColor:'transparent',paddingHorizontal:10,paddingVertical:10},clear:{width:44,minHeight:48,alignItems:'center',justifyContent:'center'}});
