...
exports.EQUIPMENT_RESOURCE_MAP_V25 = void 0;
exports.canonicalResourceV25 = canonicalResourceV25;
exports.resourceAvailableAtLevelV25 = resourceAvailableAtLevelV25;
exports.inventoryItemIdV25 = inventoryItemIdV25;
exports.missingItemRegistrationsV25 = missingItemRegistrationsV25;
const r = (v) => v;
exports.EQUIPMENT_RESOURCE_MAP_V25 = [
...
const byKey = new Map(exports.EQUIPMENT_RESOURCE_MAP_V25.map(v => [v.key, v]));
function canonicalResourceV25(key) { const v = byKey.get(key); if (!v)
    throw new Error(`unknown_equipment_resource:${key}`); return v; }
function resourceAvailableAtLevelV25(key, requiredLevel) { return canonicalResourceV25(key).minLevel <= requiredLevel; }
function inventoryItemIdV25(key) { const v = canonicalResourceV25(key); if (!v.itemId)
    throw new Error(`equipment_resource_item_registration_required:${key}:${v.regionalResourceId ?? v.globalResourceId ?? 'no_resource_id'}`); return v.itemId; }
function missingItemRegistrationsV25() { return exports.EQUIPMENT_RESOURCE_MAP_V25.filter(v => !v.itemId); }
