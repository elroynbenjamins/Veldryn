...
export function createCoopDungeonFixtureSource(language:Language,character?:CharacterState|null):CoopEntrySource{
  ...
  const eventExpeditions:CoopEventExpeditionPreview[]=[
    ...
    {id:'EVENT_TURNING_VAULT_LAST_HOUR',eventName:'Turning of the Age',name:'Vault of the Last Hour',description:'Enter a chronicle vault caught between the last midnight and the first dawn.',routeHighlights:['Fading Gallery','Ageglass Archive','Midnight Orrery'],enemyNames:['Yearless Remnant','Ageglass Sentinel','Dawnless Chronicler'],finalBoss:'The Last Hour',status:'preview'},
    {id:'EVENT_HEARTBOND_GARDEN_BROKEN_VOWS',eventName:'Heartbond Festival',name:'Garden of Broken Vows',description:'Descend through overgrown vow gardens where old promises have become hostile magic.',routeHighlights:['Rosegate Walk','Vowglass Conservatory','Forgotten Arbor'],enemyNames:['Thornbound Jealousy','Vowbreaker Shade','Heartglass Knight'],finalBoss:'The Unbound Heart',status:'preview'},
    {id:'EVENT_BLOOMWAKE_ELDERBLOOM_HOLLOW',eventName:'Bloomwake',name:'Elderbloom Hollow',description:'Travel beneath a waking sacred grove through roots, pollen caverns, and a blighted heart chamber.',routeHighlights:['Rootway Descent','Pollen Grotto','Elderbloom Heart'],enemyNames:['Blightcap Ravager','Rootwoken Stag','Pollen Wraith'],finalBoss:'Elderbloom Devourer',status:'preview'},
  ];
