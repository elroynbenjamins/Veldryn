...
const ids=['UNIT_001','UNIT_002','UNIT_003','UNIT_006','UNIT_007','UNIT_023'];
...
const wrong=['UNIT_006','UNIT_001','UNIT_003']; // Radiant / Wild / Arcane, still unique
assert.equal(validateCompanionTrialTeam({companionIds:wrong,owned,busyCompanionIds:new Set(),restrictions:oath.teamRestrictions}).ok,true);
