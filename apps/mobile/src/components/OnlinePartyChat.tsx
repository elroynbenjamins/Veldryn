...
export function OnlinePartyChat({unlockedEmoteIds=[],firstUnreadMessageId,onRead}:{unlockedEmoteIds?:readonly string[];firstUnreadMessageId?:string;onRead?:()=>void}={}){
