    ...
    <Modal visible={visible} transparent statusBarTranslucent animationType={state.settings.reduceMotion?'none':'fade'} onRequestClose={closeChat}>
      <View style={s.modalRoot}>
        ...
        <KeyboardAvoidingView behavior={Platform.OS==='ios'?'padding':'height'} style={s.keyboard}><View accessibilityViewIsModal onAccessibilityEscape={closeChat} style={s.window}>
          ...
          <View style={s.content}>{channel==='party'?<OnlinePartyChat unlockedEmoteIds={state.account.unlockedEmoteIds} trayIds={state.settings.chatEmoteTrayIds} bodyPresentation={state.character?.bodyPresentation} onTrayChange={onEmoteTrayChange} firstUnreadMessageId={partyFirstUnreadMessageId} onRead={onChatRead} reduceMotion={state.settings.reduceMotion}/>:channel==='guild'&&guildAvailable?<GuildChat language={state.settings.language} currentPlayerName={state.character?.name} unlockedEmoteIds={state.account.unlockedEmoteIds} trayIds={state.settings.chatEmoteTrayIds} bodyPresentation={state.character?.bodyPresentation} onTrayChange={onEmoteTrayChange} firstUnreadMessageId={guildFirstUnreadMessageId} onRead={onChatRead} reduceMotion={state.settings.reduceMotion}/>:onlineConfigured?<OnlineWorldChat playerName={state.character!.name} language={state.settings.language} unlockedEmoteIds={state.account.unlockedEmoteIds} trayIds={state.settings.chatEmoteTrayIds} bodyPresentation={state.character?.bodyPresentation} onTrayChange={onEmoteTrayChange} embedded reduceMotion={state.settings.reduceMotion}/>:<WorldChat language={state.settings.language} unlockedEmoteIds={state.account.unlockedEmoteIds} trayIds={state.settings.chatEmoteTrayIds} bodyPresentation={state.character?.bodyPresentation} onTrayChange={onEmoteTrayChange} embedded/>}</View>
