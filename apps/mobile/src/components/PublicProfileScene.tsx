...
const s=StyleSheet.create({
 ...
 identityPlate:{position:'absolute',left:10,top:10,maxWidth:'58%',zIndex:4,paddingHorizontal:9,paddingVertical:7,borderWidth:1,borderColor:'rgba(212,173,88,.55)',borderRadius:radii.md,backgroundColor:'rgba(8,15,24,.82)'},
