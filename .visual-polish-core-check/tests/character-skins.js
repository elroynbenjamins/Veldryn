...
let state = (0, game_1.createCharacter)((0, game_1.newGame)(1000), 'IRONWARDEN', 'SkinTester');
state = { ...state,
    ...
    overflow: { stacks: [{ itemId: set.itemIds[2], quantity: 1 }], expiresAtMs: 10000 },
...
const allCarried = { ...(0, game_1.createCharacter)((0, game_1.newGame)(2000), 'IRONWARDEN', 'Seller'), inventory: { stacks: set.itemIds.map(itemId => ({ itemId, quantity: 1 })), capacity: 30 } };
...
ok(!(0, character_skins_1.characterSkinCollection)((0, game_1.createCharacter)((0, game_1.newGame)(3000), 'BASTION', 'OtherClass')).some(skin => skin.id === skinId), 'Collections must remain character-class scoped');
...
let noviceState = (0, game_1.createCharacter)((0, game_1.newGame)(4000), 'IRONWARDEN', 'BeginnerSkinTester');
...
let eventState = (0, game_1.createCharacter)((0, game_1.newGame)(5000), 'IRONWARDEN', 'EventSkinTester');
