...
ok(isV33EquipmentPieceId('T1P_001')&&!isV33EquipmentPieceId('STONEHEART_CHEST'),'v33 ID boundary');
ok(isKnownV33EquipmentPieceId('T1P_001')&&!isKnownV33EquipmentPieceId('T9P_999'),'known v33 IDs');
