...
const s=StyleSheet.create({
  button:{minHeight:touchTargetPreferred,minWidth:0,maxWidth:'100%',paddingHorizontal:spacing.md,paddingVertical:10,justifyContent:'center',alignItems:'center',flexDirection:'row',gap:8,borderWidth:1,borderRadius:radii.sm},compact:{minHeight:touchTargetMin,paddingHorizontal:spacing.sm,paddingVertical:7,borderRadius:radii.sm},
