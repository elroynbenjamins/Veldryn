...
- Market create/fill/cancel paths -> `feature.market.enabled` (cancellation/recovery may remain available while disabled)
...
- `economy.market.trade_count`, `economy.market.gold_volume`
...
The Control site's support page is intentionally read-mostly in v17.2. It can add internal cases/notes, but it does not grant currency, edit inventories, ban, or mutate progression.
...
- market volume/price outlier (later, once market is live)
