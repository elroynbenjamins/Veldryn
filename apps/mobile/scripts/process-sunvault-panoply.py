...
REVIEW_ROOT = ROOT / "art-review" / "sunvault-panoply-v1"
CHARACTER_MASTER = REVIEW_ROOT / "character-master-checkerboard.png"
ICON_MASTER = REVIEW_ROOT / "equipment-master-checkerboard.png"
...
def main() -> None:
    ...
    output_root = ROOT / "assets" / "progression-sets" / "sunvault-panoply"
    ...
    icon = remove_checkerboard(Image.open(ICON_MASTER))
    icon_destination = ROOT / "assets" / "equipment-ui" / "sunvault-panoply-icon-sheet.png"
