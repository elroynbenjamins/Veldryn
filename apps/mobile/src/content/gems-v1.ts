...
export const MOBILE_GEM_FAMILIES_V1:readonly MobileGemFamilyV1[]=[
 {familyId:'stat_might',name:'Might',kind:'stat',category:'stat',values:vals(.004,.005,.0065,.008,.01),unit:'percent',description:'Increases Power.',legacyStat:'attack',sources:['Gloam Mite','Saffron Gate','Crafting']},
 {familyId:'stat_vitality',name:'Vitality',kind:'stat',category:'stat',values:vals(.006,.008,.01,.0125,.015),unit:'percent',description:'Increases Max HP.',legacyStat:'hp',sources:['Roadside Boar','Saffron Gate','Shiverlake Descent','Crafting']},
 {familyId:'stat_iron',name:'Iron',kind:'stat',category:'stat',values:vals(.005,.0065,.008,.01,.0125),unit:'percent',description:'Increases Armor.',legacyStat:'defense',sources:['Runebound Miner','Scorchwind Flats','Caravan of Glass','Crafting']},
 {familyId:'stat_ward',name:'Ward',kind:'stat',category:'stat',values:vals(.005,.0065,.008,.01,.0125),unit:'percent',description:'Increases Ward.',sources:['Echo Bat','Buried Observatory','Crafting']},
 {familyId:'stat_precision',name:'Precision',kind:'stat',category:'stat',values:vals(.003,.004,.005,.0065,.008),unit:'percentage_point',description:'Increases Accuracy.',sources:['Venom Weaver','Mirage Basin','Mirage Well','Crafting']},
 {familyId:'stat_keen',name:'Keen',kind:'stat',category:'stat',values:vals(.002,.003,.004,.005,.006),unit:'percentage_point',description:'Increases Critical Chance.',sources:['Ironwood Wolf','Whitepine Hunt','Crafting']},
 ...
 {familyId:'effect_bulwark',name:'Bulwark',kind:'effect',category:'defense',values:vals(.006,.0075,.009,.0105,.012),unit:'effect',description:'Blocking or defensive abilities grant temporary damage reduction.',resonance2:'Damage-reduction duration increases.',resonance3:'Successful blocks refresh the duration.',recommendedClasses:['IRONWARDEN','BASTION'],legacyEffect:'damage_reduction',sources:['Fallen Sentinel','Caravan of Glass','Party Contracts']},
