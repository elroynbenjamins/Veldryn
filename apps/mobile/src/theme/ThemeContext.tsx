...
export function GameThemeProvider({themeId,children}:{themeId?:UiThemeId;children:PropsWithChildren['children']}){
  return <ThemeContext.Provider value={resolveTheme(themeId)}>{children}</ThemeContext.Provider>;
}
