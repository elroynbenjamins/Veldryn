...
type Tab=QuickNavDestination|'Activity'|'Progression'|'AccountBonuses'|'DailySupplies'|'Arena'|'Rankings'|'Collections'|'Profile'|'Achievements'|'Combat'|'Coop';
...
function tabLabel(language:Language,tab:Tab):string{
  switch(tab){
    case 'Home':return t(language,'nav.home');case 'World':return t(language,'nav.world');case 'Character':return t(language,'nav.character');case 'Inventory':return t(language,'nav.inventory');case 'More':return 'Account';case 'Activity':return 'Character Activity';case 'Progression':return 'Working Toward';case 'AccountBonuses':return 'Account Bonuses';case 'DailySupplies':return 'Daily Supplies';
