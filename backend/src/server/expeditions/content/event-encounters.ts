import type { CombatantDefinition, DamageType } from '../../combat/types';
...
const encounter=(id:string,name:string,level:number,scale:number,damageType:DamageType,strikeName='Event Strike',waveName='Event Wave'):CombatantDefinition[]=>[
 {id:`${id}_A`,name,team:'enemies',role:'enemy',level,stats:stats(12_000*scale,5_000*scale,1_450*scale,level),basicAttackMs:2750,basicAttackCoeff:.74,abilities:[{id:`${id}_A_HIT`,name:strikeName,cooldownMs:6800,castTimeMs:700,target:'current_target',priority:70,effects:[{kind:'damage',coeff:1.02,damageType}]}]},
...
export const EVENT_ENCOUNTERS:Record<string,()=>CombatantDefinition[]>={
 ...
 EVENT_SUNCREST_BOSS:()=>boss('EVENT_SUNCREST_BOSS','Aureon, First Champion',45,1,'fire',"Champion's Lance",'Solar Nova'),
 EVENT_STARFALL_BOSS:()=>boss('EVENT_STARFALL_BOSS','The Constellation Eater',70,1.18,'arcane','Astral Lance','Constellation Nova'),
