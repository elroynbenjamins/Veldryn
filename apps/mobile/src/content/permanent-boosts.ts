...
const petBoostFor=(pet:{id:string;name:string;target:string;activeBps:number}):PermanentBoostDefinition=>{
  ...
  switch(pet.target){
    ...
    case 'miningYield': return {...base,miningYieldMultiplier:amount};
    case 'woodcuttingYield': return {...base,woodcuttingYieldMultiplier:amount};
    case 'fishingYield': return {...base,fishingYieldMultiplier:amount};
    case 'herbalismYield': return {...base,herbalismYieldMultiplier:amount};
    case 'huntingYield': return {...base,huntingYieldMultiplier:amount};
    case 'gatheringSpeed': return {...base,gatheringSpeedMultiplier:amount};
    ...
    case 'enchantingSpeed': return {...base,enchantingSpeedMultiplier:amount};
    case 'monsterMasteryXp': return {...base,monsterMasteryXpMultiplier:amount};
    case 'explorationProgress': return {...base,explorationProgressMultiplier:amount};
    case 'offlineLootCapacity': return {...base,offlineLootCapacityMultiplier:amount};
    case 'echoReward': return {...base,echoRewardMultiplier:amount};
    case 'foodDuration': return {...base,foodDurationMultiplier:amount};
