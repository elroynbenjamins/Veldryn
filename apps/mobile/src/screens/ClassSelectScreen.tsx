...
const createStyles=(C:any,equipmentColors:any)=>StyleSheet.create({
  screen:{flex:1,backgroundColor:C.bg},scroll:{flex:1},root:{width:'100%',maxWidth:520,alignSelf:'center',padding:16,paddingTop:12,gap:12,backgroundColor:C.bg},brandRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:8},wordmark:{flex:1,maxWidth:184,height:62},kicker:{fontSize:10,lineHeight:14,color:'#A5B2C4',fontWeight:'800',letterSpacing:2,textAlign:'center'},
  ...
  section:{gap:12},heading:{fontFamily:Platform.OS==='ios'?'Georgia':'serif',fontSize:25,lineHeight:32,fontWeight:'500',color:'#F1D89F',textAlign:'center'},creationPreview:{backgroundColor:'#05070A',borderTopLeftRadius:70,borderTopRightRadius:70,borderBottomLeftRadius:24,borderBottomRightRadius:24,overflow:'hidden'},creationPreviewContent:{alignItems:'center',paddingHorizontal:24,paddingVertical:24,gap:10},creationPortrait:{width:190,height:230},creationBadgeText:{fontSize:11,lineHeight:16,color:'#E9C782',fontWeight:'700',textAlign:'center'},nameBlock:{gap:6},nameField:{borderWidth:1,borderColor:'#354352',borderRadius:14,backgroundColor:C.input,paddingHorizontal:18,paddingVertical:12},nameFieldFocused:{borderColor:'#8BAFC2'},nameFieldError:{borderColor:C.bad},label:{fontSize:10,lineHeight:16,color:'#A5B2C4',fontWeight:'800',letterSpacing:1},input:{minHeight:28,color:C.text,padding:0,margin:0,fontSize:17,fontWeight:'600',textAlignVertical:'center',includeFontPadding:false},inputMeta:{flexDirection:'row',justifyContent:'space-between',gap:8},saveErrorCard:{gap:4,padding:12,borderWidth:1,borderColor:C.bad,borderRadius:12,backgroundColor:'#2a1b20'},saveErrorLabel:{fontSize:10,lineHeight:14,color:C.bad,fontWeight:'900',letterSpacing:1},error:{fontSize:12,lineHeight:18,color:'#F4D9DD',flex:1},counter:{fontSize:12,lineHeight:18,color:'#A5B2C4'},chips:{gap:8},chip:{minHeight:44,paddingHorizontal:14,borderRadius:18,justifyContent:'center',backgroundColor:C.panel2},chipText:{fontSize:14,fontWeight:'600',color:'#E9C782'},choiceRow:{flexDirection:'row',gap:8},flex:{flex:1},note:{fontSize:12,lineHeight:18,color:'#A5B2C4',textAlign:'center'},description:{fontSize:14,lineHeight:21,color:'#BCC8D5',textAlign:'center'},
  filterRow:{flexDirection:'row',gap:6},filter:{flex:1,minHeight:40,paddingHorizontal:8,borderWidth:1,borderColor:'#314259',borderRadius:99,backgroundColor:C.bg,justifyContent:'center',alignItems:'center'},filterActive:{borderColor:equipmentColors.selectedLine,backgroundColor:equipmentColors.selected},filterText:{fontSize:12,fontWeight:'700',color:'#A5B2C4'},filterTextActive:{color:'#d9f3ff'},loadout:{borderTopWidth:1,borderColor:'#25323D',paddingVertical:16,paddingHorizontal:8,flexDirection:'row',alignItems:'center',gap:12},gearName:{fontSize:15,lineHeight:21,color:'#E9C782',fontWeight:'700'},weaponTag:{fontSize:11,fontWeight:'800',color:'#96B9D1'},reviewCard:{backgroundColor:C.panel,borderRadius:20,padding:16,flexDirection:'row',alignItems:'center',gap:12},reviewCopy:{flex:1,gap:5},reviewName:{fontSize:20,lineHeight:26,color:'#F1D89F',fontWeight:'900'},reviewRole:{fontSize:14,lineHeight:20,fontWeight:'700'},reviewLine:{fontSize:13,lineHeight:19,color:'#BAC6D5'},footer:{backgroundColor:C.bg,paddingHorizontal:20,paddingTop:8,paddingBottom:12},navigation:{width:'100%',maxWidth:488,alignSelf:'center',flexDirection:'row',gap:8},
});
