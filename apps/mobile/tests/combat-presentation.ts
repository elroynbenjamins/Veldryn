...
if(!oneShotBoss.won||oneShotBoss.events.filter(event=>event.type==='player_hit').length!==1)throw new Error('Sufficiently strong players must be allowed to one-shot the Fallen Knight without phase HP locks');
