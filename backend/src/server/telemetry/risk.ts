export type SecuritySignal='duplicate_claim'|'impossible_elapsed'|'chat_spam'|'seed_mismatch'|'state_version_conflict'|'rate_limit';
const weight:Record<SecuritySignal,number>={duplicate_claim:2,impossible_elapsed:8,chat_spam:2,seed_mismatch:10,state_version_conflict:1,rate_limit:1};
