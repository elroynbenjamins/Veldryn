...
const definitions:Omit<NoviceSetDef,'slots'>[]=[
  ...
  {id:'wallkeeper_initiate',classId:'BASTION',name:'Wallkeeper Initiate',appearanceId:'beginner-wallkeeper-initiate',weaponName:'Initiate Tower Shield',weaponAttack:5,offhandName:'Initiate Guard Bell',setBonus:{name:'Unbroken Wall',attack:1,defense:12,hp:42,description:'+12 DEF and +42 HP while the full set is equipped.'},theme:{accent:'#bc8045',identity:'Maximum defense and immovable presence',material:'Dark plate, copper trim and tower shield'}},
  {id:'chainwatch_novice',classId:'DREADGUARD',name:'Chainwatch Novice',appearanceId:'beginner-chainwatch-novice',weaponName:'Novice Chained Weapon',weaponAttack:7,offhandName:'Novice Shield',setBonus:{name:'Dread Chain',attack:7,defense:3,hp:18,description:'+7 ATK and +18 HP while the full set is equipped.'},theme:{accent:'#995369',identity:'Relentless control at close range',material:'Black iron, chain and weathered hide'}},
  {id:'sunlamp_acolyte',classId:'DAWNKEEPER',name:'Sunlamp Acolyte',appearanceId:'beginner-sunlamp-acolyte',weaponName:'Acolyte Mace',weaponAttack:5,offhandName:'Acolyte Relic',setBonus:{name:'Sunlit Benediction',attack:3,defense:4,hp:55,description:'+55 HP and +3 ATK while the full set is equipped.'},theme:{accent:'#dec965',identity:'Radiant support and sacred resolve',material:'Ivory cloth, bronze and sun-gold'}},
  ...
  {id:'twinstep_initiate',classId:'KNIFE_DANCER',name:'Twinstep Initiate',appearanceId:'beginner-twinstep-initiate',weaponName:'Initiate Main Blade',weaponAttack:6,offhandName:'Initiate Second Blade',setBonus:{name:'Twin Tempo',attack:9,defense:1,hp:8,description:'+9 ATK while the full set is equipped.'},theme:{accent:'#bb6f98',identity:'Speed, precision and paired blades',material:'Light steel, charcoal cloth and soft leather'}},
  {id:'earthseal_disciple',classId:'STONECALLER',name:'Earthseal Disciple',appearanceId:'beginner-earthseal-disciple',weaponName:'Disciple Staff',weaponAttack:6,offhandName:'Disciple Totem',setBonus:{name:'Earthen Resonance',attack:4,defense:6,hp:34,description:'+6 DEF and +34 HP while the full set is equipped.'},theme:{accent:'#5aa9a1',identity:'Earthen endurance and primal support',material:'Stone, bark and teal wool'}},
];
