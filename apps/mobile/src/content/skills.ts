...
{id:'ENCHANT_DISTILL_WISP_DUST',name:'Distill Wisp Dust',skillId:'enchanting',level:1,xp:85,gold:25,seconds:60,repeatableTraining:true,inputs:[{itemId:'WISP_DUST',quantity:10}],output:{itemId:'GEM_DUST',quantity:1}},
{id:'ENCHANT_CONDENSE_GLOAM_DUST',name:'Condense Gloam Dust',skillId:'enchanting',level:20,xp:360,gold:120,seconds:180,repeatableTraining:true,inputs:[{itemId:'GLOAM_DUST',quantity:4},{itemId:'OATHGLASS_FRAGMENT',quantity:1}],output:{itemId:'GEM_DUST',quantity:5}},
{id:'ENCHANT_CRYSTALLIZE_RIME_DUST',name:'Crystallize Rime Dust',skillId:'enchanting',level:45,xp:1400,gold:800,seconds:600,repeatableTraining:true,inputs:[{itemId:'RIMEGLASS',quantity:2},{itemId:'WILD_ESSENCE',quantity:2}],output:{itemId:'GEM_DUST',quantity:16}},
