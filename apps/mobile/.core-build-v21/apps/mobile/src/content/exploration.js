...
exports.explorationRoute = exports.EXPLORATION_ROUTES = void 0;
exports.EXPLORATION_ROUTES = [
...
const explorationRoute = (id) => exports.EXPLORATION_ROUTES.find(route => route.id === id);
exports.explorationRoute = explorationRoute;
