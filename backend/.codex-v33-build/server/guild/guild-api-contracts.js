...
;
function text(v, k, min = 1, max = 128) { if (typeof v !== 'string' || v.trim().length < min || v.trim().length > max || /[\u0000-\u001f\u007f]/.test(v))
