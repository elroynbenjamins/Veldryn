...
const createStyles=(C:any,equipmentColors:any)=>StyleSheet.create({root:{padding:12,borderLeftWidth:3,borderRadius:radii.sm,backgroundColor:C.panel2},text:{...typography.bodyStrong}});
