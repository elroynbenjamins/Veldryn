...
function styles(C:ThemeColors){return StyleSheet.create({
  ...
  warning:{borderWidth:1,borderColor:C.warn,borderRadius:8,padding:spacing.sm,marginTop:spacing.sm},
  warningTitle:{...typography.caption,color:C.warn,fontWeight:'900',letterSpacing:.8},
