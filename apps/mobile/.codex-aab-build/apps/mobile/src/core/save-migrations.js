...
const fresh_start_v33_1 = require("./fresh-start-v33");
...
function migrateSave(input) {
    ...
    const invalidV33Ids = (0, fresh_start_v33_1.invalidV33EquipmentIds)(normalized);
    if (invalidV33Ids.length)
        throw new Error(`Invalid v33 equipment ID: ${invalidV33Ids[0]}`);
    const freshStart = (0, fresh_start_v33_1.applyFreshStartV33)(normalized);
