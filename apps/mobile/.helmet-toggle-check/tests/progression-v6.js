...
if (monsters_1.MONSTERS.find(m => m.id === 'MOSS_RAT').secondsPerKill !== 11)
    throw new Error('Combat action pacing missing');
if (skills_1.GATHERING.find(g => g.id === 'COPPER_VEIN').seconds !== 23)
