...
function makeStyles(C:ThemeColors){return StyleSheet.create({pill:{alignSelf:'flex-start',minHeight:22,justifyContent:'center',paddingHorizontal:7,paddingVertical:3,borderWidth:1,borderRadius:radii.full},text:{fontSize:8.5,lineHeight:11,fontWeight:'900',letterSpacing:.65}});}
