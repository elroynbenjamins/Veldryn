...
ok(!skills.includes("skillId==='hunting'")&&!skills.includes('Hunting-specific activities'),'Hunting must not return as a standalone skill');
...
ok(activity.includes('preview.explorationXp')&&activity.includes('Exploration XP'),'Combat reward cards must surface modest passive Exploration XP separately from character XP');
