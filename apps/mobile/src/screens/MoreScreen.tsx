...
export type MoreDestination='Home'|'Social'|'Activity'|'Progression'|'AccountBonuses'|'DailySupplies'|'Quests'|'Companions'|'Skills'|'Events'|'Friends'|'Guild'|'Settings'|'Arena'|'Rankings'|'Collections'|'Profile'|'Achievements';
...
function iconForDestination(id:MoreDestination):keyof typeof navigationIcons{
  ...
  if(id==='AccountBonuses')return 'Collections';
