...
ok(workingTowardExecution.includes("executionState==='active'").toString()&&workingTowardExecution.includes("executionState==='blocked'")&&workingTowardExecution.includes("executionState==='ready'"),'Execution overview counters must derive from literal execution states rather than broad goal lifecycle status');
