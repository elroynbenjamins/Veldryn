...
const REGIONAL_IDENTITY_COPY:Record<string,RegionalIdentityCopy>={
 ...
 UNIT_014:{activeName:'Mirage Spring',activeDescription:'Restores the lowest-HP ally and cycles slightly faster than a normal support active.',activeKind:'utility',activeValue:.05,passiveKind:'haste',passiveValue:.02,passiveDescription:'Oasis Rhythm: slightly improves support tempo.',bondName:'Deep Oasis',bondKind:'haste',bondValue:.02,bondDescription:'Bond 10 improves the Djinnling’s restorative tempo.'},
 ...
 UNIT_021:{activeName:'Obsidian Rend',activeDescription:'A hard-hitting attack built to keep pressure on armored enemies.',activeKind:'armor_pierce',activeValue:.06,passiveKind:'damage',passiveValue:.04,passiveDescription:'Obsidian Fang: slightly stronger basic attacks.',bondName:'Molten Pursuit',bondKind:'execute',bondValue:.04,bondDescription:'Bond 10 adds finishing pressure to the Drakelet.'},
