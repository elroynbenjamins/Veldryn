...
const duplicateGearDisplay=visibleStacks([{itemId:'WORN_BLADE',quantity:1},{itemId:'WORN_BLADE',quantity:1}],'','gear','name');
ok(duplicateGearDisplay.length===1&&duplicateGearDisplay[0].quantity===2,'Duplicate one-slot gear copies aggregate into one readable Inventory row');
ok(storageCapacityStatus([{itemId:'WORN_BLADE',quantity:1},{itemId:'WORN_BLADE',quantity:1}],2).level==='full','Duplicate gear copies still consume separate storage slots');
