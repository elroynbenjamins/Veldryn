...
export default function NativeVisualReview(){
 ...
 {section==='Journal'&&<QuestScreen state={state} mode="story" onModeChange={noop} onClaim={noop} onClaimContract={noop} onNavigate={noop} onOpenWeeklyOrder={noop} onPinWeeklyOrder={noop} onQueueWeeklyOrder={noop} onStopWeeklyOrder={noop}/>} 
