...
const s=StyleSheet.create({
 ...
 enemyField:{alignSelf:'center',alignItems:'stretch',justifyContent:'center',zIndex:2},enemyGroup:{width:'100%',flexDirection:'row',flexWrap:'wrap',alignItems:'stretch',justifyContent:'center',zIndex:2},enemySlot:{flexGrow:1,flexBasis:'48%',maxWidth:'50%',minWidth:0},
