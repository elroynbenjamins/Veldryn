...
const state = (0, game_1.createCharacter)((0, game_1.newGame)(1000), 'IRONWARDEN', 'Backup Tester');
...
ok((0, number_format_1.formatGameNumber)(12500, 'abbreviated') === '12.5K', 'Large abbreviated values must be compact');
ok((0, number_format_1.formatGameNumber)(12500, 'exact') === '12,500', 'Exact number mode must use grouped digits');
