...
-- Remote config/kill switches, telemetry buckets, central UTC resets, alerts, and read-mostly player-support tooling.
...
('feature.market.enabled','Features','Player Market','Master gate for new market orders/trades.','boolean','true','true','client_safe','critical',true,'{}','Existing escrow/order state must remain recoverable.'),
