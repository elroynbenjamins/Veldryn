import {REGIONAL_COMBAT_PRESSURE,REGIONAL_FOOD_SUSTAIN_TARGETS,REGIONAL_MIN_NET_DAMAGE_PER_KILL} from '../src/core/game';
...
for(const region of regions)ok((REGIONAL_MIN_NET_DAMAGE_PER_KILL[region]??0)>0,region+' must accumulate long-hunt attrition');
