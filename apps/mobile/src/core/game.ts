...
export const REGIONAL_FOOD_SUSTAIN_TARGETS:Readonly<Record<string,{foodPerHourMin:number;foodPerHourMax:number}>>={Greenfields:{foodPerHourMin:.8,foodPerHourMax:2},Silverbrook:{foodPerHourMin:1,foodPerHourMax:3},'Ironwood Forest':{foodPerHourMin:.8,foodPerHourMax:2.5},'Old Mines':{foodPerHourMin:.8,foodPerHourMax:3},"King's Road":{foodPerHourMin:.8,foodPerHourMax:3},Sunscar:{foodPerHourMin:.5,foodPerHourMax:2.5},Frostmarch:{foodPerHourMin:.75,foodPerHourMax:3},Ashlands:{foodPerHourMin:2.5,foodPerHourMax:6}};
