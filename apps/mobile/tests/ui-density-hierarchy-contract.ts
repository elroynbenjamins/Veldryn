...
ok(quests.includes('<JournalStat label="REWARDS"')&&quests.includes('<JournalStat label="WEEKLY"')&&quests.includes('<JournalStat label="CACHES"'),'Quest Journal must expose compact action-attention counts');
