...
exports.alchemyRecipeDef = exports.potionDef = exports.POTION_ITEMS = exports.ALCHEMY_RECIPES = exports.POTIONS = exports.MAX_ALCHEMY_BATCHES = void 0;
exports.MAX_ALCHEMY_BATCHES = 100;
exports.POTIONS = [
...
const recipe = (potionId, level, seconds, xp, gold, inputs, suffix = '') => ({
    id: `BREW_${potionId}${suffix}`, name: exports.POTIONS.find(p => p.id === potionId).name, level, seconds, xp, gold, inputs, output: { itemId: potionId, quantity: 1 },
});
...
exports.POTION_ITEMS = exports.POTIONS.map(potion => ({ id: potion.id, name: potion.name, type: 'potion',
...
const potionDef = (id) => exports.POTIONS.find(p => p.id === id);
exports.potionDef = potionDef;
const alchemyRecipeDef = (id) => exports.ALCHEMY_RECIPES.find(recipe => recipe.id === id);
exports.alchemyRecipeDef = alchemyRecipeDef;
