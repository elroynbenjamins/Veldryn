import {REGIONAL_COMBAT_PRESSURE,REGIONAL_FOOD_SUSTAIN_TARGETS} from '../src/core/game';
...
equal(REGIONAL_FOOD_SUSTAIN_TARGETS.Greenfields.foodPerHourMin,0,'starter region remains forgiving');
