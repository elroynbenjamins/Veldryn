...
export function guildMemberManagement(actorRole:GuildManagementRole,targetRole:GuildManagementRole,isSelf:boolean){
 if(isSelf||targetRole==='leader')return {canPromote:false,canDemote:false,canRemove:false};
 if(actorRole==='leader')return {
  canPromote:targetRole==='member',
  canDemote:targetRole==='officer',
  canRemove:true,
 };
 if(actorRole==='officer')return {canPromote:false,canDemote:false,canRemove:targetRole==='member'};
 return {canPromote:false,canDemote:false,canRemove:false};
}
