...
const makeStyles=(T:ThemePalette)=>StyleSheet.create({row:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between',gap:4},label:{color:T.muted,fontSize:12,lineHeight:17,flexShrink:1},value:{color:T.text,fontSize:12,lineHeight:17},track:{height:9,backgroundColor:'#080c12',borderRadius:8,overflow:'hidden',marginTop:5},fill:{height:'100%',backgroundColor:T.accent}});
