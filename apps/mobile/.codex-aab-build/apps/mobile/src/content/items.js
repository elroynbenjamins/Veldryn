...
const herbalism_1 = require("./herbalism");
const alchemy_1 = require("./alchemy");
const equipment_items_v33_1 = require("./equipment-items-v33");
const COMPLETE_SET_SLOTS = ['helmet', 'legs', 'boots', 'weapon', 'offhand', 'amulet'];
const COMPLETE_SET_CONFIG = [
...
const slotLabel = { helmet: 'Helm', chest: 'Chest', gloves: 'Gloves', legs: 'Legguards', boots: 'Boots', weapon: 'Weapon', offhand: 'Offhand', cape: 'Cape', amulet: 'Amulet', ring: 'Ring' };
const COMPLETE_SET_ADDITIONAL_ITEMS = COMPLETE_SET_CONFIG.flatMap(set => COMPLETE_SET_SLOTS.map(slot => {
...
const FROSTMARCH_SET_ITEMS = FROSTMARCH_SET_CONFIG.flatMap(set => Object.keys(slotLabel).map(slot => {
...
exports.ITEMS = [...BASE_ITEMS, ...equipment_items_v33_1.EQUIPMENT_ITEMS_V33];
function itemDef(id) { const x = exports.ITEMS.find(i => i.id === id); if (!x)
    throw new Error(`Unknown item ${id}`); return x; }
