...
const s=StyleSheet.create({stage:{backgroundColor:'#101925',borderWidth:1,borderColor:C.line,borderRadius:radii.lg,padding:spacing.md,gap:spacing.sm},header:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},kicker:{...typography.caption,color:C.accent,fontWeight:'900',letterSpacing:1},safety:{...typography.caption,fontWeight:'900'},safe:{color:C.good},steady:{color:C.warning},danger:{color:C.bad},ability:{backgroundColor:C.panel2,borderLeftWidth:3,borderLeftColor:C.accent,padding:spacing.sm,borderRadius:radii.sm},abilityName:{...typography.bodyStrong,color:C.accent},abilityText:{...typography.caption,color:C.muted},combatants:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},side:{width:'40%',alignItems:'center'},monster:{width:112,height:120},name:{...typography.bodyStrong,color:C.text,textAlign:'center'},hit:{...typography.caption,color:C.muted},versus:{alignItems:'center',gap:spacing.sm},vs:{...typography.title,color:C.accent},damage:{...typography.bodyStrong,color:C.bad},meta:{flexDirection:'row',justifyContent:'space-between'},barLabel:{...typography.caption,color:C.muted,fontWeight:'900'},barValue:{...typography.caption,color:C.text},track:{height:10,backgroundColor:C.bg,borderRadius:8,overflow:'hidden'},fill:{height:'100%',borderRadius:8}});
