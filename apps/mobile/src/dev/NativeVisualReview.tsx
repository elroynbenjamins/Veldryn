...
export default function NativeVisualReview(){
 ...
 {section==='Crafting'&&<SkillsScreen state={state} initialMode="crafting" onCraft={id=>setState(s=>craftRecipe(s,id,now))} onClaimCraft={noop} onClaimAllCrafts={noop} onCancelCraft={noop} onCraftPrerequisites={noop} onGather={noop} onQueueGather={noop} onQueueRemove={noop} onQueueMove={noop} onQueueClear={noop} onQueueStart={noop} onEquipTool={noop} onCharacter={noop} onInventory={noop} onViewToolRecipes={noop}/>} 
