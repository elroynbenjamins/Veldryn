...
state.inventory.stacks=[{itemId:'COOKED_SILVERFIN',quantity:40},{itemId:'IRONWOOD_STEW',quantity:2}];
...
assert.ok(companionStaminaSelectionTotal([{itemId:'COOKED_SILVERFIN',quantity:40},{itemId:'IRONWOOD_STEW',quantity:4}])>=100);
