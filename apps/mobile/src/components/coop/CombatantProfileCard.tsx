...
export interface BossCombatCastState{label:string;durationMs:number;interruptible:boolean;targetLabel?:string;progressStyle?:any;}
...
function makeStyles(C:ThemeColors){const equipment=equipmentTheme(C);return StyleSheet.create({
 card:{minHeight:136,borderWidth:1,borderRadius:radii.md,overflow:'hidden',backgroundColor:C.panel,shadowColor:'#000',shadowOpacity:.18,shadowRadius:3,elevation:1},
 active:{borderWidth:2,borderColor:C.info,shadowColor:C.info,shadowOpacity:.32,shadowRadius:6,elevation:3},targeted:{borderWidth:2,borderColor:C.bad},inspectSelected:{borderWidth:2,borderColor:C.info,shadowColor:C.info,shadowOpacity:.28,shadowRadius:5,elevation:3},down:{opacity:.48},inspectHitbox:{...StyleSheet.absoluteFillObject,zIndex:20,borderRadius:radii.md},inspectPressed:{backgroundColor:C.infoSurface},
