...
const custom = ['Home', 'Character', 'World', 'Inventory', 'More'];
...
if ((0, quick_navigation_1.normalizeQuickNavDestinations)(['Home', 'Home', 'Unknown']).join(',') !== quick_navigation_1.DEFAULT_QUICK_NAV_DESTINATIONS.join(','))
    throw new Error('Malformed shortcut data must fall back safely');
