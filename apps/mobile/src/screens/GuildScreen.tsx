...
const makeStyles=(T:ThemePalette)=>StyleSheet.create({root:{padding:spacing.lg,gap:spacing.md},h:{...typography.hero,color:T.text},tabs:{flexDirection:'row',flexWrap:'wrap',gap:6},tabChip:{minHeight:40,paddingHorizontal:13,justifyContent:'center',borderWidth:1,borderColor:T.line,borderRadius:99,backgroundColor:T.bg},tabChipSelected:{borderColor:T.action,backgroundColor:T.actionSurface},tabText:{fontSize:12,fontWeight:'700',color:T.muted},tabTextSelected:{color:T.actionText},pressed:{opacity:.76},title:{...typography.title,color:T.text},sub:{...typography.body,color:T.muted},track:{height:10,backgroundColor:T.panel2,borderRadius:5,overflow:'hidden',marginVertical:10},fill:{height:10,backgroundColor:T.accent},bossFill:{height:10,backgroundColor:'#b85c68'},member:{flexDirection:'row',alignItems:'center',gap:10,paddingVertical:8,borderBottomWidth:1,borderBottomColor:T.line},avatar:{width:38,height:38,borderRadius:19,backgroundColor:T.panel2,borderWidth:1,borderColor:T.accent,alignItems:'center',justifyContent:'center'},avatarText:{color:T.accent,fontWeight:'900',fontSize:18},flex:{flex:1},memberName:{color:T.text,fontWeight:'900'},status:{fontSize:12,fontWeight:'700'},statusLeader:{color:T.accent},statusOfficer:{color:T.info},statusMember:{color:T.good}});
