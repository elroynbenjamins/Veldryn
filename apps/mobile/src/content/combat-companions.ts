...
const REGIONAL_IDENTITY_COPY:Record<string,RegionalIdentityCopy>={
 ...
 UNIT_014:{activeName:'Mirage Spring',activeDescription:'Restores the lowest-HP ally and cycles slightly faster than a normal support active.',activeKind:'heal',activeValue:.05,passiveKind:'haste',passiveValue:.02,passiveDescription:'Oasis Rhythm: slightly improves support tempo.',bondName:'Deep Oasis',bondKind:'haste',bondValue:.02,bondDescription:'Bond 10 improves the Djinnling’s restorative tempo.'},
 UNIT_015:{activeName:'Solar Carapace',activeDescription:'Creates a stronger shield that reflects a small share of absorbed damage.',activeKind:'shield',activeValue:.058,passiveKind:'damage_reduction',passiveValue:.02,passiveDescription:'Sunplate: slightly improves personal durability.',bondName:'Sun Mirror',bondKind:'damage_reduction',bondValue:.02,bondDescription:'Bond 10 strengthens the Scarab’s reflective defense.'},
 UNIT_016:{activeName:'Crownward',activeDescription:'Creates a heavy royal barrier and reinforces the companion’s defensive stance.',activeKind:'shield',activeValue:.067,passiveKind:'damage_reduction',passiveValue:.04,passiveDescription:'Tyrant Guard: increased defensive stability.',bondName:'Unbroken Crown',bondKind:'shield',bondValue:.04,bondDescription:'Bond 10 strengthens Crownward and the Heir’s defensive identity.'},
 UNIT_017:{activeName:'Rimefang Rush',activeDescription:'A cold finishing strike with extra pressure against wounded enemies.',activeKind:'damage',activeValue:1.10,passiveKind:'haste',passiveValue:.02,passiveDescription:'Winter Hunt: slightly faster combat tempo.',bondName:'Shatterfang',bondKind:'execute',bondValue:.03,bondDescription:'Bond 10 sharpens the Rime Wolf’s finishing pressure.'},
 UNIT_018:{activeName:'Resonant Chime',activeDescription:'Restores the weakest ally and returns faster than most support actives.',activeKind:'heal',activeValue:.05,passiveKind:'cooldown_reduction',passiveValue:.10,passiveDescription:'Bell Rhythm: support cycles recover more quickly.',bondName:'Grand Resonance',bondKind:'haste',bondValue:.02,bondDescription:'Bond 10 adds a small tempo bonus to the Bell Sprite.'},
 UNIT_019:{activeName:'Choir Ward',activeDescription:'Raises a reinforced ward while the Golem’s resonant plating improves durability.',activeKind:'shield',activeValue:.055,passiveKind:'damage_reduction',passiveValue:.05,passiveDescription:'Resonant Plating: increased defense in companion combat.',bondName:'Fortified Hymn',bondKind:'shield',bondValue:.04,bondDescription:'Bond 10 further strengthens Choir Ward.'},
 UNIT_020:{activeName:"Wyrm's Verdict",activeDescription:'A powerful strike that becomes especially dangerous as the target nears defeat.',activeKind:'damage',activeValue:1.18,passiveKind:'execute',passiveValue:.07,passiveDescription:'Predatory Echo: stronger finishing pressure.',bondName:'Ancient Verdict',bondKind:'cooldown_reduction',bondValue:.04,bondDescription:'Bond 10 lets Wyrm’s Verdict cycle slightly faster.'},
 UNIT_021:{activeName:'Obsidian Rend',activeDescription:'A hard-hitting attack built to keep pressure on armored enemies.',activeKind:'damage',activeValue:1.10,passiveKind:'damage',passiveValue:.04,passiveDescription:'Obsidian Fang: slightly stronger basic attacks.',bondName:'Molten Pursuit',bondKind:'execute',bondValue:.04,bondDescription:'Bond 10 adds finishing pressure to the Drakelet.'},
 UNIT_022:{activeName:'Forge Barrier',activeDescription:'Creates a reinforced barrier that reflects a portion of absorbed pressure.',activeKind:'shield',activeValue:.057,passiveKind:'damage_reduction',passiveValue:.04,passiveDescription:'Custodian Plating: increased defensive stability.',bondName:'Overheat Guard',bondKind:'shield',bondValue:.04,bondDescription:'Bond 10 strengthens the Forge Custodian’s reactive guard.'},
 UNIT_023:{activeName:'Primal Arc',activeDescription:'An aggressive arc of energy with strong damage and fast combat tempo.',activeKind:'damage',activeValue:1.14,passiveKind:'haste',passiveValue:.03,passiveDescription:'Living Current: naturally faster attack tempo.',bondName:'Chain Surge',bondKind:'damage',bondValue:.03,bondDescription:'Bond 10 increases Primal Spark’s damage output.'},
 UNIT_024:{activeName:"Regent's Decree",activeDescription:'Restores the weakest ally while maintaining a faster tactical support cycle.',activeKind:'heal',activeValue:.06,passiveKind:'haste',passiveValue:.02,passiveDescription:'Shade Command: slightly faster support tempo.',bondName:'Royal Veil',bondKind:'damage_reduction',bondValue:.02,bondDescription:'Bond 10 adds a small defensive edge to Regent Shade support.'},
};
...
const regional=(id:string,name:string,rarity:CombatCompanionRarity,role:CompanionDefinition['role'],unlockRequirements:CompanionDefinition['unlockRequirements'],identity:string,region:CompanionDefinition['origin'],materialId:string,effect:CompanionEffectDefinition['kind']):CompanionDefinition=>{
  ...
  return {id,name,description:identity,archetype:identity.split('/')[0].trim(),role,rarity,origin:region,unlockRequirements,
...
/** Complete authored catalog for event-engine validation and admin QA. */
export const ALL_COMBAT_COMPANIONS:CompanionDefinition[]=[...ASTERFALL_COMPANIONS,...REGIONAL_COMPANIONS,...EVENT_COMPANIONS];
/** Player-facing roster excludes event companions until live events are released. */
export const COMBAT_COMPANIONS:CompanionDefinition[]=EVENTS_RELEASED?ALL_COMBAT_COMPANIONS:[...ASTERFALL_COMPANIONS,...REGIONAL_COMPANIONS];
export const combatCompanionDef=(id:string)=>ALL_COMBAT_COMPANIONS.find(entry=>entry.id===id);
