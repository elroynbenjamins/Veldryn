...
exports.WORLD_ZONES = [
    ...
    { id: 'FROSTMARCH', name: 'Frostmarch', subtitle: 'Frozen passes where every bell carries through the ice', minLevel: 46, maxLevel: 70, x: .42, y: .10, accent: '#91c7dc', symbol: '❄' },
