...
const createStyles=(C:any)=>StyleSheet.create({input:{minHeight:48,minWidth:0,fontSize:16,color:C.text,backgroundColor:C.input,borderWidth:1,borderColor:C.line,paddingHorizontal:14,paddingVertical:10},disabled:{opacity:.5}});
