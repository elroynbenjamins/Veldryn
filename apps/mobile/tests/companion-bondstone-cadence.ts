...
equal((bossState.inventory.stacks.find(row=>row.itemId==='TEMPERING_CORE')?.quantity??0)>=3,true,'second weekly win includes normal boss cores plus the bonus bounty Core');
