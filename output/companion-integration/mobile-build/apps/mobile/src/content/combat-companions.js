...
exports.combatCompanionDef = exports.COMBAT_COMPANIONS = exports.COMPANION_SANCTUARY_WEEKLY_ESSENCE = exports.COMPANION_SANCTUARY_TRAINING_XP_PER_DAY = exports.COMPANION_SANCTUARY_BOND_BONUS = exports.COMPANION_SANCTUARY_CONFIG = exports.COMPANION_ASCENSION_BASE_COST = exports.COMPANION_BOND_CONFIG = exports.COMPANION_LEVEL_CURVE = exports.COMPANION_STAGE_CAPS = exports.COMPANION_RARITY_CONFIG = void 0;
/**
 ...
 */
exports.COMPANION_RARITY_CONFIG = {
...
exports.COMPANION_STAGE_CAPS = {
    standard: [10, 20, 20, 20],
    rare: [10, 20, 25, 25],
    elite: [10, 20, 25, 30],
    prestige: [10, 20, 25, 35],
};
exports.COMPANION_LEVEL_CURVE = { baseXp: 65, xpGrowth: 1.16, goldBase: 38, goldGrowth: 1.24, essenceBase: 4, essenceGrowth: 1.19 };
exports.COMPANION_BOND_CONFIG = {
    maxLevel: 10,
...
exports.COMPANION_ASCENSION_BASE_COST = {
...
exports.COMPANION_SANCTUARY_CONFIG = {
...
exports.COMPANION_SANCTUARY_BOND_BONUS = [0, .05, .10, .15];
exports.COMPANION_SANCTUARY_TRAINING_XP_PER_DAY = [0, 24, 52, 84];
exports.COMPANION_SANCTUARY_WEEKLY_ESSENCE = [0, 20, 48, 80];
const ability = (id, name, description, cooldownSeconds, target, kind, baseValue, perLevel, extra = {}) => ({
...
const passive = (kind, value, description, condition) => ({ kind, value, description, condition });
const req = (type, description, target, amount) => ({ type, description, target, amount });
const origin = (id, name, type = 'region') => ({ id, name, type });
const trait = (id, name, kind, value, description, condition) => ({ id, name, description, effect: passive(kind, value, description, condition) });
...
const regional = (id, name, rarity, role, source, identity, region, materialId, effect) => ({
...
exports.COMBAT_COMPANIONS = [...ASTERFALL_COMPANIONS, ...REGIONAL_COMPANIONS];
const combatCompanionDef = (id) => exports.COMBAT_COMPANIONS.find(entry => entry.id === id);
exports.combatCompanionDef = combatCompanionDef;
