...
const s=StyleSheet.create({root:{padding:spacing.md,gap:spacing.md,paddingBottom:spacing.xl},kicker:{...typography.caption,color:C.accent,fontWeight:'900',letterSpacing:1.4},heading:{...typography.hero,color:C.text,marginTop:-6},intro:{...typography.body,color:C.muted,maxWidth:460,marginBottom:spacing.xs},attention:{padding:spacing.sm,borderWidth:1,borderColor:C.warning,borderRadius:10,backgroundColor:'#332515',gap:2},attentionTitle:{...typography.caption,color:C.warning,fontWeight:'900',letterSpacing:.8},attentionText:{...typography.caption,color:C.text},other:{marginTop:spacing.sm,paddingTop:spacing.md,borderTopWidth:1,borderTopColor:C.line,gap:2},otherKicker:{...typography.caption,color:C.muted,fontWeight:'900',letterSpacing:1},otherCopy:{...typography.caption,color:C.muted}});
