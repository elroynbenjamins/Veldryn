...
export interface RankingEntryProjection{rank:number;entityType:RankingEntityType;displayName:string;subtitle?:string;value:number;secondaryValue?:number;detail?:string;isSelf:boolean;}
