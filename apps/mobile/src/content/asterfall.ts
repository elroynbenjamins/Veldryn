export const ASTERFALL_LEVEL_BANDS=[
...
export const V1_BALANCE_TARGETS={
  targetLevel25ProductiveCombatHours:{min:60,max:96},
...
export const ASTERFALL_PRODUCTIVE_HOUR_BUDGET={
  combat:84,mining:21.6,smithing:19.2,fishing:16.8,cooking:12,woodcutting:7.2,questManual:6,gearReadiness:14.4,total:181.2
};
