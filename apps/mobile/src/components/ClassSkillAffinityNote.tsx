...
export function ClassSkillAffinityNote({classId,skillId,compact=false}:{classId?:ClassId;skillId?:string;compact?:boolean}){
 ...
 return <View style={[s.card,{backgroundColor:C.panel2,borderColor:C.line}]}>
  ...
  <Text style={[s.detail,{color:C.muted}]}>Applies to this character’s new actions. Costs and rewards per action stay the same; XP earns the stated bonus. All other skills remain available at normal rates.</Text>
 </View>;
}
