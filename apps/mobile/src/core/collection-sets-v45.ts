...
export const COLLECTION_SETS_V45:CollectionSetDefinition[]=[
 ...
 {id:'oathbound_rampart_runtime',name:'Oathbound Rampart',description:'Collect all ten pieces of the V33 Oathbound Rampart set.',theme:'combat',enabled:true,members:equipmentSetDef('T1_001')!.itemIds.map(id=>({kind:'item' as const,id,label:itemDef(id).name})),
