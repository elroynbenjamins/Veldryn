...
exports.NOVICE_SETS = definitions.map(set => ({ ...set, slots: ['chest', 'weapon', ...(set.offhandName ? ['offhand'] : []), 'gloves', 'boots', 'helmet', 'legs', 'cape', 'amulet', 'ring'] }));
...
exports.NOVICE_STAGE = { chest: 1, weapon: 2, offhand: 2, gloves: 3, boots: 3, helmet: 4, legs: 4, cape: 4, amulet: 5, ring: 5 };
const labels = { chest: 'Armor', gloves: 'Gloves', boots: 'Boots', helmet: 'Headpiece', legs: 'Legguards', cape: 'Cloak', amulet: 'Amulet', ring: 'Signet Ring' };
const prerequisite = { weapon: 'chest', offhand: 'chest', gloves: 'weapon', boots: 'weapon', helmet: 'boots', legs: 'boots', cape: 'boots', amulet: 'cape', ring: 'amulet' };
