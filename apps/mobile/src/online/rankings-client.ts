...
export const rankingsClient={board:(board:RankingBoardId,limit=50,offset=0)=>request<RankingBoardSnapshot>(`/rankings?board=${encodeURIComponent(board)}&limit=${limit}&offset=${offset}`)};
